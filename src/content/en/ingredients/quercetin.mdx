...
key_studies:
  - title: "Quercetin and Dasatinib Reduce Senescent Cells in Humans (Mayo Clinic)"
    ...
    finding: "First human pilot study with D+Q (Dasatinib + Quercetin): reduction of senescent cells in adipose tissue in n=9 individuals with diabetic kidney disease. Dasatinib is a prescription cancer drug. Quercetin alone was not tested."
  ...
  - title: "Quercetin reduces systolic blood pressure in overweight subjects"
    ...
    finding: "Double-blind crossover RCT (n=93): 150 mg quercetin/day for 6 weeks significantly reduced systolic blood pressure (~3 mmHg) and oxidized LDL in overweight, high-risk individuals."
  - title: "A systematic review and meta-analysis of Quercetin supplementation and blood pressure"
    ...
    finding: "Meta-analysis (7 RCTs, n=587): quercetin supplementation reduced systolic blood pressure by ~3.09 mmHg. Effects were significant only at ≥500 mg/day and >8 weeks duration. Effect size: small."
