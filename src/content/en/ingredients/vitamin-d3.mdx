...
key_studies:
  ...
  - title: "Effect of a six-month vitamin D supplementation on depressive symptoms in patients with major depressive episode (DepFuD): a double-blinded randomised controlled trial."
    ...
    finding: "RCT (n=281, DepFuD trial): 6-month vitamin D supplementation (high vs. low dose) showed no significant effect on depressive symptoms (Cohen's d=-0.09; 95% CI -0.32 to 0.14). Null result even in vitamin D deficient patients."
---
