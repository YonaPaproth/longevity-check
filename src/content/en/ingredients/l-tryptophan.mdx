...
category: other
summary: "L-tryptophan is the precursor to serotonin and melatonin. Biologically plausible for sleep and mood, but direct supplementation effects remain limited and variable."
evidenceLevel: "3"
evidenceSummary: "L-tryptophan is biologically plausible for sleep and mood because it serves as a precursor to both serotonin and melatonin. Evidence exists showing modest benefits, but effects are typically moderate and context-dependent. Direct supplementation is often weaker than more targeted alternatives such as 5-HTP or melatonin, and absorption depends on intestinal amino acid competition."
efsa_health_claims_allowed: false
efsa_notes: "In the EU, there are no approved health claims for L-tryptophan for sleep or mood."
...
key_studies:
  - title: "Effects of L-tryptophan on sleepiness and on sleep"
    ...
    finding: "Early human studies show potential benefits for sleep onset time and sleep quality."
  - title: "L-Tryptophan: Basic Metabolic Functions, Behavioral Research and Therapeutic Indications"
    ...
    n: 12
    finding: "Review: Tryptophan is neurobiologically relevant, but effects depend strongly on context."
  - title: "Effects of tryptophan depletion on anxiety, a systematic review"
    authors: "Young SN"
    year: 2013
    pmid: "33574223"
    url: "https://pubmed.ncbi.nlm.nih.gov/33574223/"
    finding: "Tryptophan plausibly influences serotonergic systems, but supplementation effects are not automatically substantial."
---
...
- **5-HTP**: This is the direct intermediate between tryptophan and serotonin. It bypasses the tryptophan hydroxylase step and avoids amino acid competition at the intestinal transporter. Studies suggest 5-HTP is more reliably effective for mood and sleep than tryptophan, though it carries slightly higher risk of GI side effects and potential serotonin syndrome if combined with SSRIs.

- **Melatonin**: If sleep is the goal, direct melatonin supplementation has far more robust clinical evidence, faster onset, and more predictable dosing. Typical effective doses are 0.5-10 mg taken 30-60 minutes before bed.
