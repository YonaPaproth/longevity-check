...
category: other
summary: "Alpha-GPC is a bioavailable choline form with solid brain plausibility. Data for focus and cognition are interesting but not robustly compelling."
evidenceLevel: "3"
evidenceSummary: "Alpha-GPC (choline alphoscerate) is a high-bioavailability choline precursor with plausible acetylcholine-supporting mechanism. Clinical evidence for cognition exists but is moderate in quality and effect size; single studies on athletic performance are underpowered."
efsa_health_claims_allowed: false
efsa_notes: "The EFSA has not approved any health claims for Alpha-GPC regarding focus, memory, or cognitive performance. Marketing claims are common but not evidence-based."
...
key_studies:
  - title: "Alpha-glycerylphosphorylcholine in cognitive decline"
    ...
    finding: "Older clinical data suggest cognitive benefits in specific populations, but evidence is dated and not widely replicated in modern studies."
  - title: "Effects of alpha-GPC on isometric strength"
    authors: "Ziegenfuss TN et al."
    year: 2008
    pmid: "18461736"
    url: "https://pubmed.ncbi.nlm.nih.gov/18461736/"
    finding: "Small study (n=13) suggesting athletic performance benefits, but limited power and design.\""
  - title: "Choline alphoscerate in cognitive impairment"
    authors: "Traini E et al."
    year: 2013
    pmid: "23912283"
    url: "https://pubmed.ncbi.nlm.nih.gov/23912283/"
    finding: "Review: Alpha-GPC is mechanistically sound but not a shortcut to cognitive enhancement; effects are modest and context-dependent.\""
---
