...
category: metabolic
summary: "TMG provides methyl groups and correlates with lower homocysteine. Biochemically plausible but as a healthy aging supplement, it's more niche than essential."
evidenceLevel: "3"
evidenceSummary: "TMG as a methyl-group donor is biochemically well understood and correlates with lower homocysteine. Whether this translates into meaningful health or healthy aging benefits in healthy adults remains much less clear. Human evidence is limited and context-dependent."
efsa_health_claims_allowed: false
efsa_notes: "For betaine in the EU, only narrow, specific claims regarding homocysteine metabolism under defined conditions are permitted. Broad healthy aging, performance, or liver claims lack regulatory approval."
...
key_studies:
  - title: "Betaine supplementation decreases plasma homocysteine in healthy adult humans"
    ...
    n: 12
    finding: "TMG was reliably associated with lower homocysteine levels in human studies. Whether this automatically produces clinical benefits remains unclear."
  - title: "Betaine in human nutrition"
    authors: "Craig SA"
    year: 2004
    pmid: "15321791"
    url: "https://pubmed.ncbi.nlm.nih.gov/15321791/"
    finding: "Review: TMG is metabolically relevant, particularly as a methyl-group donor and osmolyte. Clinical applications sometimes outpace the evidence base."
  - title: "Plasma lipids and betaine are related in an acute coronary syndrome cohort"
    ...
    finding: "Homocysteine decreases, but hard clinical endpoints remain unclear."
---
