...
summary: "PQQ is often linked to mitochondria and cellular energy. It sounds elegant, but human evidence remains limited."
evidenceLevel: "4"
evidenceSummary: "PQQ is mechanistically interesting, particularly regarding mitochondrial function and oxidative stress. However, human evidence remains sparse and preliminary. Many bold claims in the supplement world lack robust clinical validation, and PQQ is no exception."
efsa_health_claims_allowed: false
efsa_notes: "In the EU, there are no approved health claims for PQQ regarding energy, brain function, or mitochondrial support."
...
key_studies:
  - title: "Pyrroloquinoline quinone modulates mitochondrial quantity and function in mice"
    ...
    finding: "Mechanistic and preclinical data suggest a mitochondrial link."
  - title: "Effects of Pyrroloquinoline Quinone Disodium Salt Intake on the Serum Cholesterol Levels of Healthy Japanese Adults"
    ...
    finding: "Small human studies show signals for fatigue and inflammatory markers, but lack robust evidence."
  - title: "PQQ: a novel vitamin-like compound?"
    authors: "Rucker R et al."
    year: 2009
    pmid: "19321502"
    url: "https://pubmed.ncbi.nlm.nih.gov/19321502/"
    finding: "Review: biologically intriguing, but not sufficiently validated to support major supplement claims."
---
