...
category: adaptogens
summary: "Cordyceps is marketed for energy and endurance. The evidence is intriguing but mixed—no strong support for major performance claims."
evidenceLevel: "3"
evidenceSummary: "Cordyceps has been studied for energy, physical performance, and fatigue. Some human trials show positive signals, but the data remain heterogeneous and generally insufficient for reliable large effects."
efsa_health_claims_allowed: false
efsa_notes: "In the EU, there are no approved health claims for Cordyceps regarding endurance, energy, or performance."
...
key_studies:
  - title: "Beet supplementation mitigates post-exercise inflammation"
    ...
    finding: "Some evidence for performance or fatigue effects, but no strong, consistent evidence across studies."
  - title: "Cordyceps"
    authors: "Chen S et al."
    year: 2010
    pmid: "40608959"
    url: "https://pubmed.ncbi.nlm.nih.gov/40608959/"
    finding: "Small studies suggest subjective improvements in fatigue and vitality, though designs were often uncontrolled."
  - title: "Biologically Active Ingredients and Underlying Mechanisms of Cordyceps in Treating Respiratory Diseases: A Comprehensive Review With Future Perspectives"
    ...
    finding: "Broad preclinical activity in cell and animal models, but human data considerably more limited and less conclusive."
---
...
1. **Small, heterogeneous trials:** Most published studies involve 20–50 participants, short durations (4–12 weeks), and different dosages and protocols. Meta-analyses struggle to draw firm conclusions.

2. **Placebo effects:** Subjective measures (fatigue, vitality, well-being) are especially prone to large placebo responses. Few trials use rigorous double-blinding.

3. **Publication bias:** Positive or interesting results are more likely to be published, creating a skewed picture.

4. **Species and extract variability:** Cordyceps militaris is cultivated in many ways (mycelium, fruiting body, fermentation), and extract composition varies. It's unclear whether all forms are equivalent.

5. **Dose-response uncertainty:** Optimal dosage for humans is not established. Traditional doses and modern supplement doses may differ.
