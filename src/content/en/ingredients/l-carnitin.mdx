...
category: metabolic
summary: "L-Carnitine shuttles fatty acids into mitochondria. Sounds like a fat burner, but typically delivers less than marketing promises for healthy people."
evidenceLevel: "3"
evidenceSummary: "L-Carnitine is biologically central to fatty acid transport. Clinical benefits are plausible primarily in specific situations—carnitine deficiency, certain medical conditions, and aging populations. For healthy adults as a general fat-burner or longevity supplement, the evidence is limited."
efsa_health_claims_allowed: false
efsa_notes: "The EU has no broadly approved health claims for L-carnitine regarding fat burning, weight loss, or performance enhancement. Many of these claims are more marketing than data supports."
...
key_studies:
  - title: "Carnitine supplementation and physical performance"
    ...
    finding: "Meta-analysis: effects on body weight and performance are overall modest and inconsistent."
  - title: "Role of carnitine in disease"
    authors: "Flanagan JL et al."
    year: 2010
    pmid: "20398344"
    url: "https://pubmed.ncbi.nlm.nih.gov/20398344/"
    finding: "Review: L-carnitine is most relevant in medical specialty contexts, less so as a universal lifestyle supplement."
  - title: "L-carnitine supplementation in recovery and aging"
    ...
    finding: "Possible benefits in recovery and older populations, but no strong basis for broad general recommendations."
---
