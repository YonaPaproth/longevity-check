...
summary: "Citrus flavonoid with promising vascular and anti-inflammatory evidence in preclinical and small human studies, but overall support remains moderate."
evidenceLevel: "3"
evidenceSummary: "Hesperidin shows promise in preclinical and small human studies, particularly for endothelial function, inflammatory markers, and venous health. However, overall evidence remains moderate and insufficient to support broad healthy aging claims."
efsa_health_claims_allowed: false
efsa_notes: "In the EU, there are no generally approved health claims for hesperidin regarding circulation, veins, or vascular protection as a single ingredient in supplements."
...
key_studies:
  - title: "Hesperidin and cardiovascular health"
    ...
    finding: "Small human study demonstrating improvements in endothelial function."
  - title: "Citrus flavonoids and vascular protection"
    authors: "Testai L et al."
    year: 2013
    pmid: "23810870"
    url: "https://pubmed.ncbi.nlm.nih.gov/23810870/"
    finding: "Review: biologically plausible but clinical evidence remains comparatively limited."
  - title: "Determining Malnutrition Assessment Criteria to Predict One-Year Mortality for Locally Advanced Head and Neck Cancer Patients Undergoing Concurrent Chemoradiotherapy"
    ...
    finding: "Broad preclinical activity but human clinical relevance remains limited."
---
