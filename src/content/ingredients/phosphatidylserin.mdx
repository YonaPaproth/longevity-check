...
key_studies:
  - title: "Soy-derived phosphatidylserine improves memory function of the elderly Japanese subjects with memory complaints"
    ...
    n: 157
    finding: "RCT (n=78, Ältere mit Gedächtnisbeschwerden): 300 mg Soja-PS/Tag über 6 Monate war mit Veränderungen verbundene Gedächtnisfunktion signifikant, besonders Gesichtserkennung und -namen."
  - title: "Memory enhancement with soybean-derived phosphatidylserine in Israeli subjects with memory complaints: a double-blind and placebo-controlled trial"
    ...
    finding: "RCT (n=157, 60–90 Jahre): PS war mit Veränderungen verbundene Kurzzeitgedächtnis und Lernfähigkeit. Stärkste Effekte bei Personen mit höherem Baseline-Gedächtnisdefizit."
  ...
  - title: "Phosphatidylserine reduces stress and improves cognitive performance in elderly individuals"
    ...
    finding: "RCT: PS dämpfte Cortisolanstieg bei Belastungstest und war mit Veränderungen verbundene Stimmung und kognitive Leistung unter Stress."
---
