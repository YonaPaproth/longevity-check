...
key_studies:
  - title: "Urolithin A induces mitophagy and prolongs lifespan in C. elegans and increases muscle function in rodents"
    ...
    finding: "Nature Medicine: Urolithin A wird im Zusammenhang mit Alterungsforschung diskutierte Lebensspanne in C. elegans um ~45 % und war mit Veränderungen verbundene Muskelkraft in alten Ratten. Erstnachweis der Mitophagie-Induktion."
  - title: "Mitophagy is required for mitochondrial biogenesis and myofiber growth in response to exercise"
    ...
    finding: "Erster Humanversuch: 500 mg Urolithin A/Tag war mit Veränderungen verbundene Mitochondrienmarker im Muskelgewebe älterer Erwachsener signifikant. Gut verträglich."
  - title: "Urolithin A improves muscle strength, exercise performance, and biomarkers of mitochondrial health in older adults"
    ...
    finding: "RCT (n=66, Ältere): 1 g Urolithin A/Tag über 4 Monate war mit Veränderungen verbundene Muskelausdauer und Mitochondrien-Biomarker signifikant vs. Placebo."
  ...
  - title: "Effects of Urolithin A Supplementation on Glucose Metabolism in Healthy Adults 55+ Years Old"
    ...
    finding: "Laufende Studie (ClinicalTrials NCT06274749): Untersucht Effekte von Urolithin-A-Supplementierung auf den Glukosestoffwechsel bei gesunden Erwachsenen ab 55 Jahren. Noch keine Ergebnisse veröffentlicht."
---
