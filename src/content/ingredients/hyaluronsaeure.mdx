...
category: "other"
summary: "Körpereigenes Glycosaminoglykan mit hoher Wasserbindungskapazität. Mehrere RCTs belegen moderate Effekte auf Hautfeuchtigkeit und Faltenreduktion; orale Gelenkdaten schwächer."
evidenceLevel: "2"
evidenceSummary: "Mehrere RCTs zeigen moderate, aber konsistente Effekte auf Hautfeuchtigkeit, Elastizität und Faltenreduktion bei oraler Einnahme von 120–240 mg/Tag. Eine Meta-Analyse (2025) über 7 RCTs bestätigt statistisch signifikante Verbesserungen für Haut. Gelenkdaten beruhen auf schwächeren Studien und sind weniger überzeugend."
efsa_health_claims_allowed: false
efsa_notes: "Für orale Hyaluronsäure existieren in der EU keine zugelassenen Health Claims nach VO (EG) 1924/2006. Aussagen zu Hautverjüngung oder Gelenkschutz sind regulatorisch nicht erlaubt."
...
key_studies:
  - title: "Oral Hyaluronic Acid Supplement: Efficacy in Skin Hydration, Elasticity, and Wrinkle Depth Reduction"
    ...
    finding: "Meta-Analyse über 7 RCTs: statistisch signifikante Verbesserungen in Hautfeuchtigkeit, Elastizität und Faltentiefe. Trends für TEWL und Faltenvolumen ohne Signifikanz. Fazit: moderate, konsistente Haut-Effekte bei oraler HA."
  - title: "Oral sodium hyaluronate improves skin hydration, barrier function and signs of aging"
    ...
    finding: "RCT, n=150, 120 mg/Tag Natriumhyaluronat (1,8 MDa) über 12 Wochen: signifikant verbesserte Hautfeuchtigkeit, reduzierte TEWL, verringerte periorbitale Faltentiefe, erhöhte Epidermisdicke und NMF-Spiegel."
  - title: "Oral intake of a new full-spectrum hyaluronan improves skin profilometry and ageing"
    ...
    finding: "RCT, n=60 Frauen, 200 mg/Tag Full-Spectrum-Hyaluronan, 28 Tage: Hautfeuchtigkeit +10,6 %, Faltentiefe −18,8 %, Faltenvolumen −17,6 %, Elastizität +5,1 %. Alle Parameter statistisch signifikant."
  - title: "Ingestion of hyaluronan relieves wrinkles: a double-blinded, placebo-controlled study"
    ...
    finding: "RCT, n=96, 120–240 mg/Tag orales Hyaluronan, 12 Wochen: signifikante Verbesserung der Hautfeuchtigkeit und Unterdrückung der Faltenbildung gegenüber Placebo."
  - title: "Effect of oral hyaluronic acid supplementation on knee osteoarthritis pain"
    authors: "Kalman DS et al."
    year: 2008
    finding: "Kleine Pilot-Studie bei Knieschmerzen: Hinweise auf Schmerzreduktion nach oraler HA, aber begrenzte Stichprobengröße und keine Replikation in größeren unabhängigen Trials."
---
...
| Typ | Molekulargewicht | Orale Bioverfügbarkeit | Bemerkung |
|---|---|---|---|
| High-MW HA | &gt;1.000 kDa | gering | Schlechte Absorption, eher für topische Anwendung |
| Low-MW HA | &lt;50 kDa | besser | Passiert Darmbarriere leichter |
| Hydrolysiertes HA | variabel | am besten | Gezielt für orale Supplements optimiert |
| Full-Spectrum HA | breites Spektrum | gut | Alle MW-Fraktionen; untersucht in Michelotti 2021 |
...
|---|---|
| **Typische Dosis** | 80–240 mg/Tag (gut untersucht: 120–200 mg) |
| **Bevorzugte Form** | Hydrolysiert oder niedermolekular (&lt;300 kDa) für bessere Absorption |
| **Einnahmezeitpunkt** | Keine bekannten Präferenzen; mit oder ohne Mahlzeit |
| **Wirkungseintritt** | Erste Effekte nach ~4 Wochen, vollständiger nach 8–12 Wochen |
...
**Für wen es sinnvoll sein könnte:**
- Personen mit trockener, reifer Haut, die eine evidenzbasierte Ergänzung zur topischen Pflege suchen
- Wer bereits Retinol, Lichtschutz und ausreichend Flüssigkeitszufuhr als Basis hat und einen weiteren Baustein ergänzen möchte
- Als Kurzzeitintervention (8–12 Wochen) mit anschließender Erfolgskontrolle

**Wer wahrscheinlich nicht profitiert:**
- Personen unter 30 mit normalem Hauttypus — körpereigene HA-Spiegel sind noch hoch
- Wer gezielt Gelenkprobleme angehen möchte — hier sind andere Substanzen besser belegt
- Wer eine grundlegende Hautverjüngung erwartet — die Effektgrößen sind konsistent, aber nicht transformativ

Orale Hyaluronsäure kann **unter Umständen zur Verbesserung von Hautfeuchtigkeit und Elastizität beitragen**, besonders bei der gezielten Einnahme von hydrolysierter oder niedermolekularer HA in einer Dosis von 120–200 mg/Tag über mindestens 8 Wochen. Für Gelenke bleibt die Evidenz schwach.
