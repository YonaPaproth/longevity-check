...
category: metabolic
summary: "Beta-Alanin erhöht durch höhere Muskelcarnosin-Spiegel die Pufferkapazität bei hochintensiven Belastungen und ist daher eher ein Sportthema als ein Longevity-Tool."
evidenceLevel: "1"
evidenceSummary: "Meta-Analysen (Hobson 2012, Saunders 2017) und das ISSN-Positionspapier zeigen kleine bis moderate Leistungsgewinne bei Belastungen von ca. 1–4 Minuten, wenn die Muskelcarnosin-Spiegel durch Beta-Alanin erhöht werden. Außerhalb sportlicher Hochintensität – etwa für allgemeines Wohlbefinden oder klassisches Healthy Aging – ist die Evidenz dünn."
efsa_health_claims_allowed: false
efsa_notes: "Für Beta-Alanin gibt es in der EU keine zugelassenen Health Claims zu Leistung, Energie oder Müdigkeitsreduktion."
...
key_studies:
  - title: "Beta-alanine supplementation and exercise performance"
    ...
    n: 360
    finding: "Meta-Analyse (15 Studien) fand einen durchschnittlichen Effekt (SMD ~0,24) besonders bei hochintensiven Befreiungen von 60–240 Sekunden."
  - title: "International Society of Sports Nutrition position stand: beta-alanine"
    ...
    finding: "Das ISSN sieht einen belegten Nutzen für Sportler, die wiederholt hochintensiv belasten; keine Empfehlung für Alltagsnutzer."
  - title: "Beta-alanine supplementation and carnosine"
    authors: "Saunders B et al."
    year: 2017
    pmid: "28654511"
    url: "https://pubmed.ncbi.nlm.nih.gov/28654511/"
    finding: "Review mit aktualisierten Daten zur Carnosinsynthese, Dosis-Zeit-Kinetik und Sicherheitsprofil einschließlich Parästhesien."
---
