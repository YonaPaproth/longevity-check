...
evidenceLevel: "3"
evidenceSummary: "Tierstudien zeigen eindrucksvolle Effekte auf Sirtuine, Stoffwechsel und Lebensspanne. Humanstudien sind bislang enttäuschend: Bioverfügbarkeit nach oraler Einnahme &lt;1 %, Halbwertszeit ~2 Stunden. Mehrere RCTs und Meta-Analysen bei kardiovaskulären Endpunkten zeigten keine konsistenten Effekte. Bei Diabetikern einzelne positive Signale. EFSA hat keine Health Claims zugelassen."
...
**Empfehlung zum gegenwärtigen Zeitpunkt:** Resveratrol-Supplements sind bei gesunden Erwachsenen nicht evidenzbasiert gerechtfertigt. Wer es im Kontext von Typ-2-Diabetes oder metabolischem Syndrom einnimmt, könnte moderate Effekte auf Triglyceride und Blutzucker erzielen — unter ärztlicher Begleitung. Die Erwartungen aus dem Longevity-Marketing übersteigen die Studienlage erheblich.
