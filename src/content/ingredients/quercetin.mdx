...
key_studies:
  ...
  - title: "Quercetin prophylaxis in prevention of acute mountain sickness (AMS): a randomized, double blind, placebo controlled phase-II clinical trial"
    ...
    coi: "unclear"
    finding: "Doppelblind-RCT Phase II: Quercetin als Prophylaxe gegen akute Höhenkrankheit (AMS) vor einem Höhenaufstieg. Neue Indikation jenseits der üblichen entzündlichen oder kardiovaskulären Studien. Mechanistisch plausibel über antioxidativen Schutz unter hypoxischem Stress. Effektgröße und genaue Dosierung aus Abstract nicht vollständig ersichtlich."
---
