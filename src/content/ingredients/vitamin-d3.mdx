...
key_studies:
  ...
  - title: "Effect of a six-month vitamin D supplementation on depressive symptoms in patients with major depressive episode (DepFuD): a double-blinded randomised controlled trial."
    ...
    finding: "RCT (n=281, DepFuD-Trial): 6 Monate Vitamin-D-Supplementierung (hochdosiert vs. niedrigdosiert) zeigte keinen signifikanten Effekt auf depressive Symptome (Cohen's d=-0.09; 95% CI -0.32 bis 0.14). Null-Resultat auch bei Patienten mit Vitamin-D-Mangel."
---
